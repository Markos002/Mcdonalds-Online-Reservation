    ...
    <div class="min-h-screen flex items-center justify-center text-white">
        <div class="w-full max-w-md bg-[#2b0000]/60 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-[#ffcc00]/20">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    <x-input-label for="username" :value="__('Username')" class="text-[#ffcc00]" />
                    <x-text-input id="username" class="block mt-1 w-full rounded-md border-none focus:ring-[#ffcc00]" type="text" name="username" :value="old('username')" required autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="email" class="block mt-1 w-full rounded-md border-none focus:ring-[#ffcc00]" type="email" name="email" :value="old('email')" required autofocus autocomplete="email" />
                ...
                <!-- Confirm Password -->
                <div>
                    <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="text-[#ffcc00]" />
                    <x-text-input id="password_confirmation" class="block mt-1 w-full rounded-md border-none focus:ring-[#ffcc00]" type="password" name="password_confirmation" required autocomplete="new-password" />
