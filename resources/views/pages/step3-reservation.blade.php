    ...
    <div class="w-full max-w-5xl mx-4 sm:mx-auto bg-[#F2F3F4] dark:bg-gray-800 text-[#1b1b18] dark:text-white shadow-2xl overflow-hidden rounded-lg">
        ...
        <div class="p-8">
            <form>
                ...
                <div class="bg-gradient-to-r from-blue-300 to-blue-400 rounded-lg p-6 mb-4 shadow-md">
                    <div class="flex items-center justify-between">
                        ...
                        <input 
                            ...
                            name="package" 
                            value="package1"
                            class="w-5 h-5 text-[#C85A54] focus:ring-[#C85A54] focus:ring-2 border-gray-300"
                        >
                    </div>
                </div>

                <!-- Package 2 - Blue Background -->
                <div class="bg-gradient-to-r from-blue-300 to-blue-400 rounded-lg p-6 mb-4 shadow-md">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-6">
                            <img 
                                src={{ asset('images/package2.png') }}
                                alt="Food Package 2"
                                class="w-24 h-24 object-cover rounded-lg"
                            >
                            <div>
                ...
                <!-- Add-ons Dropdown -->
                <div class="mb-8">
                    <label for="addons" class="block text-sm font-medium mb-2 dark:text-gray-200">Add-ons</label>
                    <select 
                        id="addons" 
                        name="addons"
                    ...
                    >
                        ...
                        <option value="fries">Regular Fries</option>
                        <option value="bigmac">Big Mac</option>
                        <option value="cokefloat">Coke Float</option>
                    </select>
                </div>
